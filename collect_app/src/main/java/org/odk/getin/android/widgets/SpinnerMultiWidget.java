...
import org.odk.getin.android.widgets.warnings.SpacesInUnderlyingValuesWarning;
...
public class SpinnerMultiWidget extends ItemsWidget implements ButtonWidget, MultiChoiceWidget {
    ...
    public SpinnerMultiWidget(final Context context, FormEntryPrompt prompt) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            styledAnswerItems[i] = org.odk.getin.android.utilities.TextUtils.textToHtml(answerItems[i]);
        }
    ...
    private void showSelectedValues(List<String> selectedValues) {
        if (selectedValues.isEmpty()) {
            ...
            CharSequence answerText = org.odk.getin.android.utilities.TextUtils.textToHtml(String.format(getContext().getString(R.string.selected_answer),

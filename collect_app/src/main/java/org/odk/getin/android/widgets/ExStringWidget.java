...
import org.odk.getin.android.exception.ExternalParamsException;
import org.odk.getin.android.external.ExternalAppsUtils;
import org.odk.getin.android.utilities.ActivityAvailability;
import org.odk.getin.android.utilities.DependencyProvider;
import org.odk.getin.android.utilities.ObjectUtils;
...
public class ExStringWidget extends QuestionWidget implements BinaryWidget {
    ...
    public ExStringWidget(Context context, FormEntryPrompt prompt) {
        ...
        answer.setTextColor(getResources().getColor(R.color.text_grey));

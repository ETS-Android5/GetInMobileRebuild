...
public class ApplicationConstants {
    ...
    public static final String MAP_GIRL_ARUA_FORM_CHEW_ID = "GetInMapGirlArua2_chew";
    public static final String MAP_GIRL_ARUA_FORM_MIDWIFE_ID = "GetInMapGirlArua2_midwife";

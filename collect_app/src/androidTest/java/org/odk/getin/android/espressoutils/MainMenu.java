package org.odk.getin.android.espressoutils;
...
import static org.odk.getin.android.test.CustomMatchers.withIndex;
...
public final class MainMenu {
    ...
    public static void startBlankForm(String text) {
        onView(withId(R.id.chew_button)).perform(click());

...
import org.odk.getin.android.test.MockedServerTest;
...
import static org.odk.getin.android.test.TestUtils.assertMatches;
import static org.odk.getin.android.test.TestUtils.cleanUpTempFiles;
import static org.odk.getin.android.test.TestUtils.createTempFile;
import static org.odk.getin.android.test.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("Dalvik/.* org.odk.getin.android/.*", r.getHeader("User-Agent"));
